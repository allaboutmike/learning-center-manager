...
public class ReviewRepositoryIntegrationTest {
    ...
    void shouldFindTutorWithReviewCount() {
        ...
        Review review1 = new Review("testing 123", 4, tutor);
        Review review2 = new Review("testing 123", 4, tutor);
        Review review3 = new Review("testing 123", 4, tutor);
    ...
    void shouldFindTutorWithAverageRating() {
        ...
        Review review = new Review("testing 123", 4, tutor);
