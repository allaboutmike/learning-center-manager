...
public interface TutorRepository extends CrudRepository<Tutor, Long> {
    ...
    @Query("SELECT t from Tutor t, Child c WHERE c.childId = :childId and c.gradeLevel BETWEEN t.minGradeLevel and t.maxGradeLevel")
    ...
    @Query("SELECT t from Tutor t JOIN t.subjects s, Child c WHERE c.childId = :childId and s.name = :subjectName and c.gradeLevel BETWEEN t.minGradeLevel and t.maxGradeLevel")
    ...
    @Query("SELECT t from Tutor t JOIN t.subjects s JOIN t.tutorTimeSlots tts JOIN tts.timeslot timeslot, Child c WHERE c.childId = :childId and s.name = :subjectName and c.gradeLevel BETWEEN t.minGradeLevel and t.maxGradeLevel and timeslot.time = :timeSlot")
