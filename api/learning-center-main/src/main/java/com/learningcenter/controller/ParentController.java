...
public class ParentController {
    ...
    public List<ChildResponse> searchChildrenByParentId(@RequestParam(required = true) Long parentId) {
        var children = parentService.getChildrenByParent(parentId);

        return ResponseEntity.ok(children).getBody();
    }
