...
(
    subject_id   INTEGER not null GENERATED BY DEFAULT AS IDENTITY,
...
(
    tutor_subject_id INTEGER not null GENERATED BY DEFAULT AS IDENTITY,
...
(
    parent_id   BIGINT GENERATED BY DEFAULT AS IDENTITY,
    name        VARCHAR(50) not null,
...
(
    time_slot_id INTEGER not null GENERATED BY DEFAULT AS IDENTITY,
...
(
    tutor_time_slot_id INTEGER not null GENERATED BY DEFAULT AS IDENTITY,
    tutor_id          INTEGER not null,
...
(
    ...
    tutor_time_slot_id INTEGER not null,
