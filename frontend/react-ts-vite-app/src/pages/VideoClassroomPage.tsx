...
import { useVonageWhiteboard } from "@/hooks/useVonageWhiteboard";
...
export default function VideoClassroomPage() {
    ...
    // Hook handles script loading + session setup
    useVonageWhiteboard({ whiteboardRef });
        ...
        <div className="p-6">
            ...
            >
                ...
                <div className="h-[70vh] p-4">
                    {React.createElement("white-board", { ref: whiteboardRef })}                </div>
            </dialog>
        </div>
    );
}